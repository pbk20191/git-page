var $t=Object.defineProperty;var Gt=(t,i,e)=>i in t?$t(t,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[i]=e;var Ce=(t,i,e)=>Gt(t,typeof i!="symbol"?i+"":i,e);import{t as ue,a as X,e as zt}from"../chunks/a5WjkIqk.js";import{z as Ot,b as Wt,i as st,h as xe,C as Jt,d as Ht,K as v,a2 as Kt,e as jt,g as Tt,j as lt,n as De,ac as Qt,k as Ut,l as Yt,m as Zt,aA as it,ag as Dt,ai as kt,aB as Xt,V as ea,aC as Lt,aD as ta,aE as aa,af as sa,aF as la,az as ia,aG as ra,aH as oa,B as na,w as va,p as Pe,c as s,t as de,a as $e,s as l,r as a,T as le,ap as rt,Y as ua,$ as pa,W as Re}from"../chunks/Dbtdn9f7.js";import{d as Ge,e as At}from"../chunks/xKwX_C3Q.js";import{h as da}from"../chunks/BcMQNMkF.js";import{s as Vt}from"../chunks/DAD-lUWQ.js";import{i as ca}from"../chunks/Dt9NjwHj.js";import{a as Ct}from"../chunks/i5uILAt2.js";import{w as ot,t as fa}from"../chunks/4eif3qM-.js";import{a as E,b as ve,J as ma}from"../chunks/BzzBhkj3.js";import{b as be,s as ha}from"../chunks/DizoNBs4.js";import{s as R}from"../chunks/gfzC0wA8.js";import{r as y,s as p}from"../chunks/DCfzdB8P.js";import{p as ft}from"../chunks/BIPL7g2D.js";function Se(t,i){return i}function ga(t,i,e,n){for(var k=[],r=i.length,w=0;w<r;w++)aa(i[w].e,k,!0);var q=r>0&&k.length===0&&e!==null;if(q){var S=e.parentNode;sa(S),S.append(e),n.clear(),ge(t,i[0].prev,i[r-1].next)}la(k,()=>{for(var x=0;x<r;x++){var u=i[x];q||(n.delete(u.k),ge(t,u.prev,u.next)),ia(u.e,!q)}})}function ze(t,i,e,n,k,r=null){var w=t,q={flags:i,items:new Map,first:null};{var S=t;w=xe?st(Jt(S)):S.appendChild(Ot())}xe&&Ht();var x=null,u=!1,A=Kt(()=>{var d=e();return va(d)?d:d==null?[]:Dt(d)});Wt(()=>{var d=v(A),h=d.length;if(u&&h===0)return;u=h===0;let g=!1;if(xe){var B=w.data===jt;B!==(h===0)&&(w=Tt(),st(w),lt(!1),g=!0)}if(xe){for(var V=null,b,L=0;L<h;L++){if(De.nodeType===8&&De.data===Qt){w=De,g=!0,lt(!1);break}var $=d[L],N=n($,L);b=Nt(De,q,V,null,$,N,L,k,i,e),q.items.set(N,b),V=b}h>0&&st(Tt())}xe||ba(d,q,w,k,i,n,e),r!==null&&(h===0?x?Ut(x):x=Yt(()=>r(w)):x!==null&&Zt(x,()=>{x=null})),g&&lt(!0),v(A)}),xe&&(w=De)}function ba(t,i,e,n,k,r,w){var q=t.length,S=i.items,x=i.first,u=x,A,d=null,h=[],g=[],B,V,b,L;for(L=0;L<q;L+=1){if(B=t[L],V=r(B,L),b=S.get(V),b===void 0){var $=u?u.e.nodes_start:e;d=Nt($,i,d,d===null?i.first:d.next,B,V,L,n,k,w),S.set(V,d),h=[],g=[],u=d.next;continue}if(_a(b,B,L),(b.e.f&it)!==0&&Ut(b.e),b!==u){if(A!==void 0&&A.has(b)){if(h.length<g.length){var N=g[0],I;d=N.prev;var J=h[0],ee=h[h.length-1];for(I=0;I<h.length;I+=1)Rt(h[I],N,e);for(I=0;I<g.length;I+=1)A.delete(g[I]);ge(i,J.prev,ee.next),ge(i,d,J),ge(i,ee,N),u=N,d=ee,L-=1,h=[],g=[]}else A.delete(b),Rt(b,u,e),ge(i,b.prev,b.next),ge(i,b,d===null?i.first:d.next),ge(i,d,b),d=b;continue}for(h=[],g=[];u!==null&&u.k!==V;)(u.e.f&it)===0&&(A??(A=new Set)).add(u),g.push(u),u=u.next;if(u===null)continue;b=u}h.push(b),d=b,u=b.next}if(u!==null||A!==void 0){for(var H=A===void 0?[]:Dt(A);u!==null;)(u.e.f&it)===0&&H.push(u),u=u.next;var K=H.length;if(K>0){var te=q===0?e:null;ga(i,H,te,S)}}kt.first=i.first&&i.first.e,kt.last=d&&d.e}function _a(t,i,e,n){Xt(t.v,i),t.i=e}function Nt(t,i,e,n,k,r,w,q,S,x){var u=(S&ra)!==0,A=(S&oa)===0,d=u?A?ea(k):Lt(k):k,h=(S&ta)===0?w:Lt(w),g={i:h,v:d,k:r,a:null,e:null,prev:e,next:n};try{return g.e=Yt(()=>q(t,d,h,x),xe),g.e.prev=e&&e.e,g.e.next=n&&n.e,e===null?i.first=g:(e.next=g,e.e.next=g.e),n!==null&&(n.prev=g,n.e.prev=g.e),g}finally{}}function Rt(t,i,e){for(var n=t.next?t.next.e.nodes_start:e,k=i?i.e.nodes_start:e,r=t.e.nodes_start;r!==n;){var w=na(r);k.before(r),r=w}}function ge(t,i,e){i===null?t.first=e:(i.next=e,i.e.next=e&&e.e),e!==null&&(e.prev=i,e.e.prev=i&&i.e)}const qt=""+new URL("../workers/icodecs-J0k5jsnj.js",import.meta.url).href;class Et{constructor(i,e,n,k=8){Ce(this,"data");Ce(this,"width");Ce(this,"height");Ce(this,"depth");this.data=i,this.width=e,this.height=n,this.depth=k}}Et.prototype.colorSpace="srgb";var Ve;(function(t){t[t.YUV444=1]="YUV444",t[t.YUV422=2]="YUV422",t[t.YUV420=3]="YUV420",t[t.YUV400=4]="YUV400"})(Ve||(Ve={}));var Ne;(function(t){t[t.Auto=0]="Auto",t[t.PSNR=1]="PSNR",t[t.SSIM=2]="SSIM"})(Ne||(Ne={}));const Bt={quality:50,qualityAlpha:-1,speed:6,subsample:Ve.YUV420,autoTiling:!1,tileColsLog2:0,tileRowsLog2:0,chromaDeltaQ:!1,sharpness:0,denoiseLevel:0,tune:Ne.Auto,sharpYUV:!1};let ya=new TextDecoder("utf-8",{ignoreBOM:!0,fatal:!0});ya.decode();const nt=new TextEncoder;"encodeInto"in nt||(nt.encodeInto=function(t,i){const e=nt.encode(t);return i.set(e),{read:t.length,written:e.length}});var vt;(function(t){t[t.GRAYSCALE=1]="GRAYSCALE",t[t.RGB=2]="RGB",t[t.YCbCr=3]="YCbCr"})(vt||(vt={}));var ut;(function(t){t[t.JPEG_Annex_K=0]="JPEG_Annex_K",t[t.Flat=1]="Flat",t[t.MSSIM_Tuned_Kodak=2]="MSSIM_Tuned_Kodak",t[t.ImageMagick=3]="ImageMagick",t[t.PSNR_HVS_M_Tuned_Kodak=4]="PSNR_HVS_M_Tuned_Kodak",t[t.Klein_Silverstein_Carney=5]="Klein_Silverstein_Carney",t[t.Watson_Taylor_Borthwick=6]="Watson_Taylor_Borthwick",t[t.Ahumada_Watson_Peterson=7]="Ahumada_Watson_Peterson",t[t.Peterson_Ahumada_Watson=8]="Peterson_Ahumada_Watson"})(ut||(ut={}));vt.YCbCr,ut.ImageMagick;var It;(function(t){t[t.Default=-1]="Default",t[t.False=0]="False",t[t.True=1]="True"})(It||(It={}));var pt;(function(t){t[t.Default=-1]="Default",t[t.Zero=0]="Zero",t[t.Left=1]="Left",t[t.Top=2]="Top",t[t.Average0=3]="Average0",t[t.Select=4]="Select",t[t.Gradient=5]="Gradient",t[t.Weighted=6]="Weighted",t[t.TopRight=7]="TopRight",t[t.TopLeft=8]="TopLeft",t[t.LeftLeft=9]="LeftLeft",t[t.Average1=10]="Average1",t[t.Average2=11]="Average2",t[t.Average3=12]="Average3",t[t.Average4=13]="Average4",t[t.Best=14]="Best",t[t.Variable=15]="Variable"})(pt||(pt={}));pt.Default;var Fe;(function(t){t[t.None=0]="None",t[t.SegmentSmooth=1]="SegmentSmooth",t[t.Dithering=2]="Dithering"})(Fe||(Fe={}));var qe;(function(t){t[t.None=0]="None",t[t.Fast=1]="Fast",t[t.Best=2]="Best"})(qe||(qe={}));const Mt={lossless:!1,nearLossless:100,quality:75,targetSize:0,targetPSNR:0,method:4,snsStrength:50,filterStrength:60,filterSharpness:0,filterType:!0,segments:4,pass:1,sharpYUV:!1,preprocessing:Fe.None,autofilter:!1,partitionLimit:0,alphaCompression:1,alphaFiltering:qe.Fast,alphaQuality:100,exact:!1,emulateJpegSize:!1,lowMemory:!1,partitions:0,showCompressed:0,imageHint:0,threadLevel:0,useDeltaPalette:0},wa=["ultrafast","superfast","veryfast","faster","fast","medium","slow","slower","veryslow","placebo"],xa=["420","422","444"],Sa=["psnr","ssim","grain","fastdecode"],Ft={quality:50,lossless:!1,preset:"slow",tune:"ssim",tuIntraDepth:2,complexity:50,chroma:"420",sharpYUV:!1,bitDepth:8};var dt;(function(t){t[t.UVAdapt=0]="UVAdapt",t[t.UV420=1]="UV420",t[t.UV444=2]="UV444",t[t.UVAuto=3]="UVAuto"})(dt||(dt={}));var ct;(function(t){t[t.YCoCg=0]="YCoCg",t[t.YCbCr=1]="YCbCr",t[t.Custom=2]="Custom",t[t.YIQ=3]="YIQ"})(ct||(ct={}));dt.UVAuto,ct.YCoCg;globalThis._icodec_ImageData=(t,i,e,n)=>n===8?new za(t,i,e):new Et(t,i,e,n);class za extends ImageData{constructor(){super(...arguments);Ce(this,"depth",8)}}function Ta(t,i){i({...Ft})}var ka=ue("<option> </option>"),La=ue("<option> </option>"),Aa=ue("<option> </option>"),Ca=ue('<div class="card svelte-1dgh8ms"><div class="title svelte-1dgh8ms">HEIC  (x265,HEVC) Options</div> <div class="grid svelte-1dgh8ms"><div><div class="row svelte-1dgh8ms"><label for="heic-quality">Quality <span class="muted svelte-1dgh8ms"> </span></label></div> <div class="row svelte-1dgh8ms"><input id="heic-quality" type="range" min="0" max="100"></div> <div class="row svelte-1dgh8ms"><label><input name="heic-lossless" type="checkbox"> Lossless</label></div> <div class="row svelte-1dgh8ms"><label for="heic-preset">Preset</label> <select id="heic-preset"></select></div> <div class="row svelte-1dgh8ms"><label for="heic-tune">Tune</label> <select id="heic-tune"></select></div> <div class="row svelte-1dgh8ms"><label for="heic-tuIntraDepth">TU Intra Depth <span class="muted svelte-1dgh8ms"> </span></label></div> <div class="row svelte-1dgh8ms"><input id="heic-tuIntraDepth" type="range" min="1" max="4"></div></div> <div><div class="row svelte-1dgh8ms"><label for="heic-complexity">Complexity <span class="muted svelte-1dgh8ms"> </span></label></div> <div class="row svelte-1dgh8ms"><input id="heic-complexity" type="range" min="0" max="100"></div> <div class="row svelte-1dgh8ms"><label for="heic-chroma">Chroma</label> <select id="heic-chroma"></select></div> <div class="row svelte-1dgh8ms"><label><input name="heic-sharpYUV" type="checkbox"> Sharp YUV</label></div> <div class="row svelte-1dgh8ms"><button>Reset</button></div></div></div></div>');function Ra(t,i){Pe(i,!0);let e=ft(i,"value",15);const n={quality:`
    /**
 ...
 *
 * @default false
 */`};var w=Ba(),q=l(s(w),2),S=s(q),x=s(S),u=s(x),A=l(s(u)),d=s(A,!0);a(A),a(u),a(x);var h=l(x,2),g=s(h);y(g),a(h);var B=l(h,2),V=s(B),b=l(s(V)),L=s(b,!0);a(b),a(V);var $=l(V,2);y($),a(B);var N=l(B,2),I=s(N),J=l(s(I)),ee=s(J,!0);a(J),a(I);var H=l(I,2);y(H),a(N);var K=l(N,2),te=l(s(K),2);ze(te,21,()=>n,Se,(f,se)=>{var W=Na(),fe={},we=s(W,!0);a(W),de(()=>{fe!==(fe=v(se).v)&&(W.value=(W.__value=v(se).v)==null?"":v(se).v),R(we,v(se).label)}),X(f,W)}),a(te),a(K);var j=l(K,2),ie=s(j),_=s(ie);y(_),le(),a(ie),a(j);var z=l(j,2),M=s(z),Z=l(s(M)),Q=s(Z,!0);a(Z),a(M);var F=l(M,2);y(F),a(z);var U=l(z,2),Y=s(U),D=l(s(Y)),T=s(D,!0);a(D),a(Y);var G=l(Y,2);y(G),a(U),a(S);var ae=l(S,2),re=s(ae),oe=s(re),m=s(oe);y(m),le(),a(oe),a(re);var c=l(re,2),C=s(c),P=l(s(C)),O=s(P,!0);a(P),a(C);var ne=l(C,2);y(ne),a(c);var he=l(c,2),_e=s(he),Ie=l(s(_e)),Ee=s(Ie,!0);a(Ie),a(_e);var Te=l(_e,2);y(Te),a(he);var ce=l(he,2),ye=l(s(ce),2);ze(ye,21,()=>k,Se,(f,se)=>{var W=Ea(),fe={},we=s(W,!0);a(W),de(()=>{fe!==(fe=v(se).v)&&(W.value=(W.__value=v(se).v)==null?"":v(se).v),R(we,v(se).label)}),X(f,W)}),a(ye),a(ce);var ke=l(ce,2),Ue=s(ke),Le=s(Ue);y(Le),le(),a(Ue),a(ke);var Ae=l(ke,2),Oe=s(Ae);Oe.__click=[Va,e],a(Ae),a(ae),a(q),a(w),de(()=>{p(x,"title",r.quality),R(d,e().quality),p(B,"title",r.qualityAlpha),R(L,e().qualityAlpha),p(N,"title",r.speed),R(ee,e().speed),p(K,"title",r.subsample),p(j,"title",r.autoTiling),p(z,"title",r.tileColsLog2),R(Q,e().tileRowsLog2),p(U,"title",r.tileColsLog2),R(T,e().tileColsLog2),p(re,"title",r.chromaDeltaQ),p(c,"title",r.sharpness),R(O,e().sharpness),p(he,"title",r.denoiseLevel),R(Ee,e().denoiseLevel),p(ce,"title",r.tune),p(ke,"title",r.sharpYUV)}),E(g,()=>e().quality,f=>e(e().quality=f,!0)),E($,()=>e().qualityAlpha,f=>e(e().qualityAlpha=f,!0)),E(H,()=>e().speed,f=>e(e().speed=f,!0)),be(te,()=>e().subsample,f=>e(e().subsample=f,!0)),ve(_,()=>e().autoTiling,f=>e(e().autoTiling=f,!0)),E(F,()=>e().tileRowsLog2,f=>e(e().tileRowsLog2=f,!0)),E(G,()=>e().tileColsLog2,f=>e(e().tileColsLog2=f,!0)),ve(m,()=>e().chromaDeltaQ,f=>e(e().chromaDeltaQ=f,!0)),E(ne,()=>e().sharpness,f=>e(e().sharpness=f,!0)),E(Te,()=>e().denoiseLevel,f=>e(e().denoiseLevel=f,!0)),be(ye,()=>e().tune,f=>e(e().tune=f,!0)),ve(Le,()=>e().sharpYUV,f=>e(e().sharpYUV=f,!0)),X(t,w),$e()}Ge(["click"]);const Fa="icodec_encoder_options";async function Pa(t,i,e){const n=Array.from(t.currentTarget.files??[]),k=async function*(){for(const r of n)yield{file:r,fullPath:r.name}}();try{Re(i,!0),await e(k)}finally{Re(i,!1)}}function $a(t,i){window.localStorage.setItem("icodec_encoder_options",JSON.stringify(Vt(v(i))))}var Ga=ue('<meta name="description" content="Converter for heif">'),Oa=ue('<div class="container svelte-l4mzdf"><div class="section svelte-l4mzdf"><!></div> <div class="drop-zone svelte-l4mzdf" role="region" aria-label="file-drop-zone"></div> <div class="section svelte-l4mzdf"><div class="field svelte-l4mzdf"><label for="icodec-images">images</label> <input type="file" id="icodec-images" multiple accept="image/png, image/jpeg"></div></div> <div class="section svelte-l4mzdf"><details class="svelte-l4mzdf"><summary class="svelte-l4mzdf">WEBP</summary> <div class="body svelte-l4mzdf"><!></div></details> <details class="svelte-l4mzdf"><summary class="svelte-l4mzdf">HEIC</summary> <div class="body svelte-l4mzdf"><!></div></details> <details class="svelte-l4mzdf"><summary class="svelte-l4mzdf">AVIF</summary> <div class="body svelte-l4mzdf"><!></div></details></div> <div class="section svelte-l4mzdf"><button class="svelte-l4mzdf">save config in local</button></div></div>');function rs(t,i){Pe(i,!0);let e=rt(!1),n=rt(ua({webp:{...Mt},avif:{...Bt},heic:{...Ft}}));Ct(()=>{let _=window.localStorage.getItem(Fa);_&&Re(n,JSON.parse(_),!0)});let k=rt(!1);Ct(()=>{Re(k,window.crossOriginIsolated,!0)});async function r(_){let z=new Worker(qt,{type:"module"});const M=navigator.hardwareConcurrency-1||4,Z=[];Z.push(z);const Q=[];Q.push(ot(z));const F=[];ot(z);const U=new ma;let Y=[],D=0;try{for await(const T of _){D+=1;const G=D;if(F.length>=M){const oe=await Promise.race(F.map(c=>c.promise)),m=F.findIndex(c=>c.id===oe.idx);m!=-1&&F.splice(m,1),Q.push(oe.worker)}else F.length<M&&Q.length===0&&(z=new Worker(qt,{type:"module"}),Z.push(z),Q.push(ot(z)));let ae=Q.pop();const re=Promise.try(async()=>{let oe=T.file;try{let m=await createImageBitmap(oe);const c=await ae.encodeBitmap(fa(m,[m]),Vt(v(n))),C=T.fullPath.replace(/\.[^/.]+$/,""),P=C.split("/"),O=P.slice(0,-1).join("/"),ne=P[P.length-1];console.log({fileBaseName:ne,folderPath:O,outputName:C,components:P}),c.avif.status==="fulfilled"?U.file(`${O}/avif/${ne}.avif`,c.avif.value):(console.error(c.avif.reason),Y.push({type:"avif",reason:c.avif.reason,fileName:T.fullPath})),c.heic.status==="fulfilled"?U.file(`${O}/heic/${ne}.heic`,c.heic.value):(console.error(c.heic.reason),Y.push({type:"heic",reason:c.heic.reason,fileName:T.fullPath})),c.webp.status==="fulfilled"?U.file(`${O}/webp/${ne}.webp`,c.webp.value):(console.error(c.webp.reason),Y.push({type:"webp",reason:c.webp.reason,fileName:T.fullPath}))}catch(m){console.error(m),Y.push({reason:m,fileName:T.fullPath})}return{idx:G,worker:ae}});F.push({id:G,promise:re})}await Promise.allSettled(F.map(T=>T.promise))}finally{for(const T of Z)T.terminate()}if(D!=0){const T=await U.generateAsync({type:"blob"});ha(T,"converted_images.zip")}Y.length>0&&alert(JSON.stringify(Y))}function w(_){!v(e)&&_.dataTransfer&&_.dataTransfer.types.length>0&&_.dataTransfer.types[0]==="Files"&&_.preventDefault()}async function q(_){var F;const z=(F=_.dataTransfer)==null?void 0:F.items;if(!z||z.length==0||v(e))return;_.preventDefault();let M=[];const Z=async function*(){for(let U=0;U<z.length;U++){const D=z[U].webkitGetAsEntry();D&&(D.isDirectory?M.push(D):D.isFile&&(yield D))}for(;M.length>0;){let Y=M.pop().createReader();const D=await new Promise((T,G)=>{Y.readEntries(T,G)});for(const T of D){const G=T.isDirectory;T.isFile===!0?yield T:G===!0&&M.push(T)}}}(),Q=async function*(){for await(const U of Z){const Y=await new Promise((D,T)=>{U.file(D,T)});Y.type.startsWith("image/")&&(yield{fullPath:U.fullPath.substring(1),file:Y})}}();Re(e,!0);try{await r(Q)}finally{Re(e,!1)}}var S=Oa();da(_=>{var z=Ga();pa.title="About",X(_,z)});var x=s(S),u=s(x);{var A=_=>{var z=zt("Processing");X(_,z)},d=_=>{var z=zt("⚠️ This is pretty slow");X(_,z)};ca(u,_=>{v(e)?_(A):_(d,!1)})}a(x);var h=l(x,2),g=l(h,2),B=s(g),V=l(s(B),2);V.__change=[Pa,e,r],a(B),a(g);var b=l(g,2),L=s(b),$=l(s(L),2),N=s($);Da(N,{get value(){return v(n).webp},set value(_){v(n).webp=_}}),a($),a(L);var I=l(L,2),J=l(s(I),2),ee=s(J);Ra(ee,{get value(){return v(n).heic},set value(_){v(n).heic=_}}),a(J),a(I);var H=l(I,2),K=l(s(H),2),te=s(K);Ma(te,{get value(){return v(n).avif},set value(_){v(n).avif=_}}),a(K),a(H),a(b);var j=l(b,2),ie=s(j);ie.__click=[$a,n],a(j),a(S),de(()=>{V.disabled=v(e),ie.disabled=v(e)}),At("drop",h,q),At("dragover",h,w),X(t,S),$e()}Ge(["change","click"]);export{rs as component};
